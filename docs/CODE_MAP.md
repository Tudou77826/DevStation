...
| Agent 注册与运行编排  | [`registry.ts`](../src/main/agents/registry.ts)、[`runtime-service.ts`](../src/main/agents/runtime-service.ts)                                           | [接入指南](./ADDING_CODING_AGENT.md)、`adapter-contract.test.ts` |
...
| Coding Agent 设置     | [`CodingAgentsPane.tsx`](../src/renderer/src/components/settings/CodingAgentsPane.tsx)                                                                   | RPC、`AgentSettingsRepo`、组件与 Electron E2E                    |
