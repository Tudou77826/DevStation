...
| 任务界面                          | [`components/tasks/`](../src/renderer/src/components/tasks/)                                                                                              | Renderer Data Store；列表与详情均在主工作区                               | `TaskPanel.test.tsx`、`TaskDetailView.test.tsx`                                       |
| 项目与会话界面                    | [`NavTree.tsx`](../src/renderer/src/components/sidebar/NavTree.tsx)、[`AISpaceWorkArea.tsx`](../src/renderer/src/components/workarea/AISpaceWorkArea.tsx) | Renderer Data Store                                                       | `NavTree.test.tsx`、`SessionList.test.tsx`、Electron E2E                              |
| 导航与上下文右栏                  | [`store/nav.ts`](../src/renderer/src/store/nav.ts)、[`RightPanel.tsx`](../src/renderer/src/components/rightpanel/RightPanel.tsx)                          | 一级/二级导航与当前选择                                                   | `RightPanel.test.tsx`、Electron E2E                                                   |
